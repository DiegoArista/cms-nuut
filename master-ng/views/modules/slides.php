...
?>
	...
	<!--=====================================
			...
			<div id="imgSlide" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                ...
                <p><span class="fa fa-arrow-down"></span>  Arrastra aquí tu imagen, tamaño recomendado: 1600px * 600px 
                y peso recomendado 2 MB.</p>
                    ...
                    <?php 
                        //mostramos todas las imagenes del slider en el servidor
                ...
                <hr>
                    ...
                    <?php 
                        //mostramos todas las imagenes del slider en el servidor para editarlas por separado
                        $slide = new GestorSlide();
